 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/2_Programing/1_Courses/2_TI_CCWorkspace/tirtos_builds_CC2640R2_LAUNCHXL_release_ccs/Debug/configPkg/package/cfg/release_pem3");
