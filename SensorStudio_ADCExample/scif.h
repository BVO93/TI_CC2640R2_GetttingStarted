/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     SensorControlStudioADCLevelTrigger
  * - <b>Project file</b>:     D:/2_Programing/1_Courses/2_TI_CCWorkspace/SensorControl_ADCTrigger.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2020-08-16 11:38:13.668
  * - <b>Computer</b>:         DESKTOP-NBF4NCA
  * - <b>User</b>:             bjorn
  *
  ...
  *
  *
  * \subsection section_task_desc_adc_level_trigger AdcLevelTrigger
  * No description entered
  *
  */
...
/// AdcLevelTrigger: Task configuration structure
typedef struct {
    uint16_t threshold; ///< 
} SCIF_ADC_LEVEL_TRIGGER_CFG_T;


/// AdcLevelTrigger: Task output data structure
typedef struct {
    uint16_t adcValue; ///< 
} SCIF_ADC_LEVEL_TRIGGER_OUTPUT_T;


/// AdcLevelTrigger: Task state structure
typedef struct {
    uint16_t high; ///< 
