...
release.xm3g: package/cfg/release_pm3g.om3g 
	...
	@$(MSG) lnkm3g $@ ...
	$(RM) $(XDCCFGDIR)$@.map
	$(gnu.targets.arm.M3.rootDir)/bin/arm-none-eabi-gcc -mthumb -march=armv7-m -nostartfiles -Wl,-static -Wl,--gc-sections    -o $@ package/cfg/release_pm3g.om3g -Wl,-T,package/cfg/release_pm3g.xdl   -LC:/ti/simplelink_cc2640r2_sdk_4_40_00_10/kernel/tirtos/packages/gnu/targets/arm//libs/install-native/arm-none-eabi/lib/thumb/v7-m -Wl,--start-group -lgcc -lc -lm -Wl,--end-group --specs=nano.specs -Wl,-Map=$(XDCCFGDIR)/$@.map --specs=nosys.specs
