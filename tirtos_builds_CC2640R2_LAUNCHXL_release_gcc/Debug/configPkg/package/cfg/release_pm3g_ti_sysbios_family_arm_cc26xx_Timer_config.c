...
/* Object__DESC__C */
#ifndef ti_sysbios_family_arm_cc26xx_Timer_Object__DESC__CR
extern __FAR__ const xdc_runtime_Core_ObjDesc ti_sysbios_family_arm_cc26xx_Timer_Object__DESC__C;
#else
#define ti_sysbios_family_arm_cc26xx_Timer_Object__DESC__C (*((xdc_runtime_Core_ObjDesc*)(xdcRomConstPtr + ti_sysbios_family_arm_cc26xx_Timer_Object__DESC__C_offset)))
#endif

/* Object__PARAMS__C */
#ifndef ti_sysbios_family_arm_cc26xx_Timer_Object__PARAMS__CR
extern __FAR__ const ti_sysbios_family_arm_cc26xx_Timer_Params ti_sysbios_family_arm_cc26xx_Timer_Object__PARAMS__C;
#else
#define ti_sysbios_family_arm_cc26xx_Timer_Object__PARAMS__C (*((ti_sysbios_family_arm_cc26xx_Timer_Params*)(xdcRomConstPtr + ti_sysbios_family_arm_cc26xx_Timer_Object__PARAMS__C_offset)))
#endif
...
xdc_runtime_Types_Label* ti_sysbios_family_arm_cc26xx_Timer_Handle__label__S(xdc_Ptr obj, xdc_runtime_Types_Label *lab) __attribute__ ((externally_visible));
xdc_Bool ti_sysbios_family_arm_cc26xx_Timer_Module__startupDone__S(void) __attribute__ ((externally_visible));
xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__create__S(xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb) __attribute__ ((externally_visible));
xdc_Void ti_sysbios_family_arm_cc26xx_Timer_Object__delete__S(xdc_Ptr instp) __attribute__ ((externally_visible));
xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__get__S(xdc_Ptr oarr, xdc_Int i) __attribute__ ((externally_visible));
xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__first__S(void) __attribute__ ((externally_visible));
xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__next__S(xdc_Ptr obj) __attribute__ ((externally_visible));
xdc_Void ti_sysbios_family_arm_cc26xx_Timer_Params__init__S(xdc_Ptr dst, const xdc_Void *src, xdc_SizeT psz, xdc_SizeT isz) __attribute__ ((externally_visible));
