...
/* Object__DESC__C */
#ifndef ti_sysbios_knl_Semaphore_Object__DESC__CR
extern __FAR__ const xdc_runtime_Core_ObjDesc ti_sysbios_knl_Semaphore_Object__DESC__C;
#else
#define ti_sysbios_knl_Semaphore_Object__DESC__C (*((xdc_runtime_Core_ObjDesc*)(xdcRomConstPtr + ti_sysbios_knl_Semaphore_Object__DESC__C_offset)))
#endif

/* Object__PARAMS__C */
#ifndef ti_sysbios_knl_Semaphore_Object__PARAMS__CR
extern __FAR__ const ti_sysbios_knl_Semaphore_Params ti_sysbios_knl_Semaphore_Object__PARAMS__C;
#else
#define ti_sysbios_knl_Semaphore_Object__PARAMS__C (*((ti_sysbios_knl_Semaphore_Params*)(xdcRomConstPtr + ti_sysbios_knl_Semaphore_Object__PARAMS__C_offset)))
#endif
