 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/2_Programing/2_LaunchXL/1_TestCodeWorkspace/central_bidirectional_audio_cc2640r2lp_app/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
