 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/2_Programing/1_Courses/2_TI_CCWorkspace/central_bidirectional_audio_cc2640r2lp_app/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
